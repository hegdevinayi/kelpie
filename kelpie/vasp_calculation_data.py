...
class VaspCalculationData(object):
    ...
    def calculation_data_as_dict(self):
        calculation_data = {
            ...
            'forces': self.forces[self.n_ionic_steps - 1],
            'initial_stress': self.stress_tensors[0],
            'final_stress': self.stress_tensors[self.n_ionic_steps - 1],
            'initial_lattice_vectors': self.lattice_vectors[0],
            'final_lattice_vectors': self.lattice_vectors[self.n_ionic_steps - 1],
