...
class TestVaspStructure(unittest.TestCase):
    ...
    def setUp(self):
        self.vstruct_ok = vs.VaspStructure(poscar_file='sample_poscars/POSCAR.OK')
    ...
    def test_get_scaling_factor(self):
        ...
        with self.assertRaises(ValueError):
            vs.VaspStructure('sample_poscars/POSCAR.scaling_factor_error')
    ...
    def test_get_lattice_vectors(self):
        ...
        with self.assertRaises(ValueError):
            vs.VaspStructure(poscar_file='sample_poscars/POSCAR.lattice_vectors_error')
    ...
    def test_get_list_of_elements(self):
        ...
        with self.assertRaises(vs.VaspStructureError):
            vs.VaspStructure(poscar_file='sample_poscars/POSCAR.list_of_elements_error')
    ...
    def test_get_list_of_number_of_atoms(self):
        ...
        with self.assertRaises(ValueError):
            vs.VaspStructure(poscar_file='sample_poscars/POSCAR.list_of_number_of_atoms_error')

    def test_get_coordinate_system(self):
        self.assertEqual(self.vstruct_ok.coordinate_system, 'Direct')
        with self.assertRaises(NotImplementedError):
            vs.VaspStructure(poscar_file='sample_poscars/POSCAR.selective_dynamics_error')
        with self.assertRaises(vs.VaspStructureError):
            vs.VaspStructure(poscar_file='sample_poscars/POSCAR.coordinate_system_error')
    ...
    def test_get_list_of_atomic_coordinates(self):
        ...
        with self.assertRaises(ValueError):
            vs.VaspStructure(poscar_file='sample_poscars/POSCAR.list_of_atomic_coordinates_error')
